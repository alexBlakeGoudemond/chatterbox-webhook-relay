package za.co.psybergate.chatterbox.infrastructure.adapter.in.web.controller;
...
public class GithubWebhookController {
    ...
    private final GithubWebhookPort githubWebhookPort;
    ...
    public ResponseEntity<String> handleGithubWebhook(@RequestHeader("X-GitHub-Event") String eventType,
        ...
        githubWebhookPort.process(eventType, deliveryId, rawBody);
